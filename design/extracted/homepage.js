  ...
  return (
    <section className="hero heroA">
      <Ph
        ...
        label="hero · tea field / loose leaf, full-bleed"
      />
      <div className="heroA__inner">
        <div className="wrap-wide">
          ...
          <h1 className="display">
            ...
            <br />
            <span className="italic-accent">by the kilogram.</span>
          </h1>
          <p className="lede">
            Handpicked from the finest leaves across 15+ countries.
            Certified-organic loose leaf, bulk tea bags and botanical herbs —
            trusted by Australia's leading cafés, retailers and wellness brands.
          </p>
          <div className="hero__cta">
            ...
            >
              Explore our teas <Icon name="arrow" />
            </button>
            <button
        ...
        <div className="heroB__grid">
          <div>
            ...
            <h1 className="display">
              ...
              Australia's
              <br />
              <span style={{ color: 'var(--green)' }}>favourite cups.</span>
            </h1>
            <p className="lede">
              1,000+ tea, herb and spice lines — 500+ certified organic —
              sourced direct and sold by the kilo. Buy online today, or apply
              for a bulk account on 100kg+ orders.
            </p>
            <div className="hero__cta">
              <button
                ...
                onClick={() => go('collection', { title: 'Tea' })}
              >
                Shop the range <Icon name="arrow" />
              </button>
              <button
                className="btn btn-ghost btn-lg"
                onClick={() => go('wholesale')}
            ...
            <div className="hero__trust">
              <span className="pill organic">
                <span className="dot" /> ACO + USDA Organic
              </span>
              <span className="pill">
                <Icon name="medal" w={13} /> 15 Golden Leaf awards
              </span>
              <span className="pill">
                <Icon name="shield" w={13} /> HACCP certified
              </span>
            </div>
          </div>
          <div style={{ position: 'relative' }}>
            ...
            <div className="heroB__badge">
              <span className="ic">
                <Icon name="medal" w={16} />
              </span>
              <div>
                <div className="serif">Gold Medal</div>
                <div
                  className="mono"
    ...
    <section className="hero heroC">
      <div className="wrap-wide">
        <div className="heroC__inner">
          <span
            className="eyebrow hero__eyebrow no-rule"
          ...
          <p className="lede">
            A curated house of certified-organic teas, wild-grown herbs and rare
            botanicals — for the businesses that care where every leaf comes
            from.
          </p>
          ...
          <div className="heroC__specimen">
            <Ph
              variant="on-dark"
              label="specimen · single hero leaf, centered"
            />
            <div className="heroC__chips">
              <span className="heroC__chip c1">
                <span className="dot" /> SINGLE ORIGIN
              </span>
              <span className="heroC__chip c2">
                <span className="dot" /> 500+ ORGANIC
              </span>
              <span className="heroC__chip c3">
                <span className="dot" /> 15 COUNTRIES
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="wrap-wide">
        ...
        <div className="range__grid">
          {TV.range.map((r) => (
            <a
              key={r.title}
              className="rtile reveal"
              href="#"
              onClick={(e) => {
                e.preventDefault()
                go('collection', { title: r.title })
              }}
            >
...
function BestSellers({ go }) {
  const picks = TV.products
    .filter((p) => p.tags.some((t) => /best|award/i.test(t)))
    .slice(0, 4)
      ...
      <div className="wrap-wide">
        <div className="range__head reveal">
          <div>
            ...
            <h2 className="h-xl" style={{ marginTop: 16 }}>
              The blends they reorder.
            </h2>
          </div>
          <button
            className="link-arrow"
            onClick={() => go('collection', { title: 'Best sellers' })}
          >
            Shop best sellers <Icon name="arrow" />
          </button>
        </div>
        <div className="rail">
          {list.map((p) => (
    ...
    <section className="section-pad">
      <div className="wrap-wide">
        <div className="range__head reveal">
          ...
          <p className="muted" style={{ maxWidth: '34ch' }}>
            Develop custom blends, manufacture tea bags and ship fully-packaged
            private-label product — all under one certified roof.
          </p>
        </div>
        <div className="svc">
          {TV.services.map((s) => (
            <article className="svc__card reveal" key={s.n}>
              <Ph
                ...
                variant={s.n === '02' ? 'on-gold' : 'on-dark'}
                label=""
              />
              <div className="svc__n">
                {s.n} · {s.tag}
              </div>
              <h3 className="serif">{s.title}</h3>
              <p>{s.body}</p>
              <button className="link-arrow" onClick={() => go('services')}>
      ...
      <div className="wrap-wide">
        <div className="split">
          <div className="reveal">
            ...
            <h2 className="h-lg" style={{ margin: '16px 0 14px' }}>
              Herbs & spices, sourced direct from farm.
            </h2>
            <p className="muted">
              We supply only the freshest wild-grown herbs and certified-organic
              spices, sourced directly from trusted farmers and plantations
              across the globe — with quality, sustainability and reliability
              built in.
            </p>
            ...
            <button
              ...
              style={{ marginTop: 26 }}
              onClick={() => go('collection', { title: 'Herbs & Spices' })}
            >
              Shop herbs & spices <Icon name="arrow" />
            </button>
          </div>
          <div className="split__media reveal">
            <Ph variant="on-dark" label="organic herbs & spices · flat-lay" />
          </div>
        </div>
      </div>
    </section>
      ...
      <div className="certs__track">
        {items.map((c, i) => (
          <div className="certs__item" key={i}>
            <Icon name={ics[i % 6]} className="ic" w={26} /> {c}
          </div>
        ))}
      </div>
    </section>
    ...
    <section className="section-pad">
      <div className="wrap-wide">
        <div className="range__head reveal" style={{ marginBottom: 50 }}>
          ...
          <p className="muted" style={{ maxWidth: '34ch' }}>
            From purpose-led startups to the country's biggest beverage names —
            they value fresh, organic ingredients and flexible, reliable supply.
          </p>
        </div>
        <div className="tst">
          <div className="tst__brands">
            {TV.testimonials.map((x, idx) => (
              <button
                key={x.brand}
                className={'tst__brand' + (idx === i ? ' on' : '')}
                onClick={() => setI(idx)}
              >
                <Ph
                  className="logo"
                  variant={idx % 2 ? 'on-gold' : ''}
                  label=""
                />
                <div className="meta">
                  <div className="b">{x.brand}</div>
                  <div className="r">{x.role}</div>
                </div>
              </button>
            ))}
          </div>
          <div className="tst__panel" key={i}>
            ...
            <blockquote className="tst__quote reveal in">
              "{t.quote}"
            </blockquote>
    ...
    <section className="section-pad">
      <div className="wrap-wide">
        <div className="range__head reveal">
          ...
          <button className="link-arrow" onClick={() => go('journal')}>
...
function HelpSection() {
  ...
  return (
    <section
      className="section-pad bg-green"
      ...
      <div className="wrap-wide">
        <div className="help">
          <div className="reveal">
            ...
            <h2
              className="h-xl"
              style={{ color: 'var(--paper)', marginTop: 16 }}
            >
              Speak with our
              <br />
              ingredients experts.
            ...
            <p
              style={{
                color: 'oklch(0.9 0.02 100 / 0.8)',
                marginTop: 16,
                maxWidth: '42ch',
              }}
            >
              Our tea masters, naturopaths and supply-chain specialists are on
              hand to source the right ingredients — at the right price — for
              your business.
            </p>
            <div className="help__contact" style={{ marginTop: 36 }}>
              <a className="line" href="tel:1300729617">
                <span className="ic">
                  <Icon name="phone" />
                </span>
                <div>
                  <div className="k">Call us</div>
                  <div className="v" style={{ color: 'var(--paper)' }}>
                    1300 729 617
                  </div>
                </div>
              </a>
              <a className="line" href="mailto:info@teavision.com.au">
                <span className="ic">
                  <Icon name="mail" />
                </span>
                <div>
          ...
          <div className="card-surface reveal" style={{ padding: '30px' }}>
            {sent ? (
              ...
              >
                ...
                >
                  <Icon name="check" w={28} />
                </span>
                <h3
                  className="serif"
                  style={{ marginTop: 20, fontSize: '1.6rem' }}
                >
                  Thanks — we'll be in touch.
                </h3>
                <p className="muted" style={{ marginTop: 8 }}>
                  One of our specialists will reach out within one business day.
                </p>
              </div>
            ) : (
              <form
              ...
              >
                ...
                <div className="field full">
                  <label>Message</label>
                  <textarea placeholder="Tell us what you're looking to source…" />
                </div>
                <button
                  className="btn btn-primary btn-lg field full"
                  type="submit"
                >
