    ...
    >
      <div className="pcard__media">
        ...
        <div className="pcard__add">
          ...
          >
            Add 250g · {aud(p.price * 2.4)}
          </button>
        </div>
      </div>
      <div className="pcard__body">
        <div className="pcard__origin">
          <Icon name="globe" w={12} /> {p.origin} · {p.type}
        </div>
        <h3 className="pcard__name">{p.name}</h3>
        <div className="pcard__row">
          <span className="pcard__price">
            {aud(p.price)} <span className="unit">{p.kg}</span>
          </span>
        ...
        <div className="ft__top">
          <div className="ft__brand">
            ...
            <p>
              ...
              organic, award-winning, ethically sourced from 15+ countries —
              serving 2,000+ businesses since 2014.
            </p>
            <div className="ft__quality">
              {TV.certs.slice(0, 4).map((c) => (
          ...
          <div className="ft__news">
            ...
            >
              ...
              >
                <Icon name="phone" w={14} /> 1300 729 617
              </a>
              <a
                href="mailto:info@teavision.com.au"
                style={{ display: 'flex', gap: 8, alignItems: 'center' }}
              >
                <Icon name="mail" w={14} /> info@teavision.com.au
              </a>
            </div>
          </div>
        </div>
