...
- hypothesis: design clamps/truncates long quotes via CSS
  evidence: .tst\_\_quote (extracted-design.html:1036) has only font-family/size/line-height; no max-height, line-clamp, or overflow rules. Design solves length editorially with condensed quotes.
