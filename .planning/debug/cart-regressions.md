...
4. Cart section width matches adjacent sections / rest of site
   actual: |
5. Price and quantity columns no longer align under headers (regression from 11-11 restyle)
6. Slashed compare-at prices no longer appear (regression — worked before)
7. Every +/- click triggers visible loading cycle
8. Container max-width mismatch between cart section and adjacent sections
