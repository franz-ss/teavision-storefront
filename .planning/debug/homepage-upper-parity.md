...
|---|---|---|---|
| h1 copy | **"Australia's #1 tea company"** (owner override; already in `HOMEPAGE_HERO.title`, content.ts:105) | Hardcoded "A world of tea mastery, *by the kilogram.*" (hero.tsx:32-35) | Render `{HOMEPAGE_HERO.title}` |
