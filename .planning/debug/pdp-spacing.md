...
- checked: design-system.css lines 628–755 (.crumb, .pdp*, .sizes/.size, .pdp__buy, .pdp__assure, .tiers/.tier, .specs/.spec-acc, .spectable, .related), 90–151 (.eyebrow, h1 base, .wrap-wide, .btn/.btn-lg), 383–386 (.qty), tokens lines 40–42
