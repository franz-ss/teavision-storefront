...
- [x] 11-07-PLAN.md — Homepage lower: BrushCircle/Stamp motifs, brand bands, testimonials, journal, newsletter, contact, FAQ
- [x] 11-08-PLAN.md — Collections + product card redesign (absorbs Phase 9 CARD-02..06 intents)
- [x] 11-09-PLAN.md — Search surfaces restyled to PLP language
- [x] 11-10-PLAN.md — PDP: layout, gallery, variant tiles, buy row, bulk-savings tiers, quick view, rails
...
- [x] 11-16-PLAN.md — Gap closure: homepage upper+lower parity, approved copy, certs marquee mount, newsletter env/warn fix
- [x] 11-17-PLAN.md — Gap closure: PLP banner hero + star rating + grid, collections index grid + contact move, search empty state
- [x] 11-18-PLAN.md — Gap closure: cart column alignment, visible compare-at prices, optimistic quantity, container width
...
| 11. Full Visual Redesign                 | 19/22 | In Progress|  |
