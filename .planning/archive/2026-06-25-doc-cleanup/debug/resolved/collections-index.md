...
4. Contact section ("Need help? Speak with our Ingredients Experts Today." + form) at bottom of page.
   actual: |
5. Page renders a "Directory / All collections" text-list section (lines 262-300 of page.tsx).
6. Card grid ("Popular paths") shows only 8 collections sourced from the Shopify nav menu
...
7. No contact section at the bottom.
