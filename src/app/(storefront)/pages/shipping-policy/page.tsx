      ...
      <Section.Container>
        <div className="max-w-prose">
          ...
          <p className="type-body text-ink-soft mt-5">
            This code-owned route keeps the shipping policy URL available for
          ...
          >
            ...
            <p className="type-body text-ink-soft mt-4">
              This page is a placeholder for the approved shipping policy. It
              identifies the canonical shipping route and marks that delivery
              and dispatch wording is not final legal advice.
            </p>
            <p className="type-body text-ink-soft mt-4">
              Until owner/legal approval is recorded, contact Teavision at
              info@teavision.com.au for questions about shipping, fulfilment,
              or policy review status.
            </p>
          </Card>
        </div>
      </Section.Container>
