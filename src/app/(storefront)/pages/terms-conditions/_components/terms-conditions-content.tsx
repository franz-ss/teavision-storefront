    ...
    <div className={cn(...termsContentClassNames)}>
      ...
      <article aria-labelledby="refund-policy-heading">
        ...
        <p>
          ...
          unfortunately we can&apos;t offer you a credit or exchange.
        </p>
        <p>
          To be eligible for a return, exchange or credit, your item must be
          considered defective or damaged and must be reported within 14 days of
          receiving your order.
        </p>
        <p>
          Teavision is a wholesaler and does not provide warranty on the product
          if the product has been repackaged, re-blended or incorrectly stored
          (see our storage conditions statement below).
        </p>
        ...
        <p>
          Teavision supplies Agricultural products many of which are organic. We
          have a tolerance level of 3% foreign matter being agricultural
          products such as stones, leaves, bark etc and do not consider there to
          be a contamination unless the contamination is greater then 3% and as
          such, we do not warranty and minor contaminations that are
          agricultural in nature.
        </p>
        <p>
          The shelf life provided by Teavision at the time of supply is subject
          to the purchaser / consumer meeting our recommended storage conditions
          which are defined here: Products should be stored at ambient
          temperature in an air tight packaging away from direct sunlight and
          humidity. It is especially important in warmer climates where humidity
          is high to ensure appropriate storage to avoid insect contaminations.
        </p>
        <p>
          Teavision can supply CoA (certificate of analysis) upon request for
          any ingredient to show that the product and batch has been tested to
          meet Australian food health and safety standards. If you require
          further testing such as heavy metal or others then we recommend you
          test this yourself using one of the labs available in Australia.
        </p>

        <h3>Defective products &amp; Claims</h3>
        <p>
          If you believe that your product is defective, contaminated or
          otherwise unfit for consumption, please report this to our team at
          info@teavision.com.au and we will investigate this for you.
        </p>
        <p>
          If a product is proven to be defective after Teavision has conducted
          an investigation, and a claim is being made, Teavision will issue a
          credit on the agreed amount but will not offer a refund. Each case is
          unique and may be treated differently depending on the circumstances
          and Teavision management team will assist with this process to find a
          fair and reasonable outcome for all parties.
        </p>
        <p>
        ...
        <p>
          ...
          notify you of the approval or rejection of your credit.
        </p>
        ...
        <p>
          ...
          info@teavision.com.au and we will assist with the next steps.
        </p>
        ...
        <p>
          ...
          Teavision&apos;s listed business address.
        </p>
        <p>
          You will be responsible for paying for your own shipping costs for
          returning your item. Shipping costs are non-refundable. If you receive
          a credit, the cost of return shipping may also be included in your
          credit.
        </p>
        <p>
