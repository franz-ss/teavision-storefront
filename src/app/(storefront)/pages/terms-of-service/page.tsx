...
const policy = getLegalPolicy('terms-of-service')
      ...
      <Section.Container>
        <div className="max-w-prose">
          ...
          <p className="type-body text-ink-soft mt-5">
            This code-owned route keeps the terms of service URL available for
          ...
          >
            ...
            <p className="type-body text-ink-soft mt-4">
              This page is a placeholder for the approved terms of service. It
              identifies the canonical terms route for launch review without
              making final legal promises.
            </p>
            <p className="type-body text-ink-soft mt-4">
              Until owner/legal approval is recorded, contact Teavision at
              info@teavision.com.au for questions about ordering terms,
              account use, or policy review status.
            </p>
          </Card>
        </div>
      </Section.Container>
