        ...
        <div className="max-w-prose">
          ...
          >
            ...
            <p className="type-body text-ink-soft mt-4">
              This page is a placeholder for the approved privacy policy. It
              identifies the canonical privacy route and marks that policy copy
              is not final legal advice.
            </p>
            <p className="type-body text-ink-soft mt-4">
              Until owner/legal approval is recorded, contact Teavision at
              info@teavision.com.au for questions about privacy handling,
              account data, or policy review status.
            </p>
          </Card>
        </div>
      </Section.Container>
