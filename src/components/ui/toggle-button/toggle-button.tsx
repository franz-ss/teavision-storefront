  ...
  ],
  {
    variants: {
      variant: {
        ...
        thumbnail:
          'relative size-16 shrink-0 overflow-hidden rounded opacity-60 hover:opacity-100 focus-visible:ring-offset-1 aria-pressed:opacity-100 aria-pressed:ring-ring aria-pressed:ring-2',
